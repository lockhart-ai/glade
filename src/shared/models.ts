// The models the input bar's picker offers, and how it names a task's model. One place, so the list stays small and
// correct: the current Opus, Sonnet and Haiku, by the ids the SDK takes (see `docs/sdk-notes.md`).
...
/** The models the picker offers, most capable first. The first is the default for a new task. */
