...
- Each ticket has acceptance criteria. A ticket is done when they all hold and tests cover the logic.
...
better-sqlite3, Vitest, ESLint + Prettier, electron-builder, xterm.js + node-pty. See `docs/decisions.md`. Prefer
well-established, widely adopted libraries and idiomatic use of them; don't pull in small or obscure packages.
